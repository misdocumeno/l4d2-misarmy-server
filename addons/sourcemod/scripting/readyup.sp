...
ConVar 
	...
	// game
	l4d_ready_disable_spawns, l4d_ready_survivor_freeze, l4d_ready_freeze_countdown, l4d_ready_show_panel,
	// sound
	...
	// action
	l4d_ready_delay, l4d_ready_live_countdown, l4d_ready_tp_on_countdown, l4d_ready_force_extra, l4d_ready_autostart_delay, l4d_ready_autostart_delay_2nd_round, l4d_ready_autostart_wait, l4d_ready_autostart_min, l4d_ready_unbalanced_start, l4d_ready_unbalanced_min;
...
public void OnPluginStart()
{
	...
	SetupFullyLoadedClients();
	RegConsoleCmd("sm_loaded", OnLoadedCmd);
}

Action OnLoadedCmd(int client, int args) {
	ReplyToCommand(client, "fully loaded players:");
...
public void OnPlayerRunCmdPost(int client, int buttons, int impulse, const float vel[3], const float angles[3], int weapon, int subtype, int cmdnum, int tickcount, int seed, const int mouse[2])
{
	if (inReadyUp && IsClientInGame(client))
	{
		...
		{
			if (readySurvFreeze || (inLiveCountdown && l4d_ready_freeze_countdown.BoolValue))
			{
