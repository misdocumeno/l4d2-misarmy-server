...
new bool:isPsychoticWitch[4097];
...
new Handle:cvarPsychoticChargeTimer[4097];
...
{
	CreateConVar("l4d_pwm_version", PLUGIN_VERSION, "Pscyhotic Witch Version", FCVAR_NONE|FCVAR_SPONLY|FCVAR_DONTRECORD|FCVAR_NOTIFY);
	...
	cvarNightmareClawType = CreateConVar("l4d_pwm_nightmareclawtype", "1", "Type of Nightmare Claw: 1 = Survivor is set to B&W, 2 = Survivor is killed.", FCVAR_NONE, true, 1.0, true, 2.0);
	...
	cvarShamefulCloakVisibility = CreateConVar("l4d_pwm_shamefulcloakvisibility", "0", "Modifies the visibility of the Witch while using Shameful Cloak. (0-255) (Def 0)", FCVAR_NONE, true, 0.0, true, 255.0);
