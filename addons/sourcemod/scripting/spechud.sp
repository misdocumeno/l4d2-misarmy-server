...
public void OnPluginStart()
{
	...
	HookConVarChange(l4d_ready_cfg_name, OnReadyCfgNameChanged);
...
void OnReadyCfgNameChanged(ConVar cvar, const char[] oldValue, const char[] newValue) {
    strcopy(sReadyCfgName, sizeof sReadyCfgName, newValue);
}
...
{
	if (IsInReady() || (LibraryExists("pause") && IsInPause()))
