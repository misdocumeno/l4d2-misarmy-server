...
SpawnPositioner_OnModuleStart() {
	...
	hCvarSpawnProximityMin = CreateConVar( "ss_spawn_proximity_min", "500", "Closest an SI may spawn to a survivor", FCVAR_NONE, true, 1.0 );
	hCvarSpawnProximityMax = CreateConVar( "ss_spawn_proximity_max", "650", "Furthest an SI may spawn to a survivor", FCVAR_NONE, true, float(GetConVarInt(hCvarSpawnProximityMin)) );
...
public SpawnPositionerMode(ConVar convar, const char[] oldValue, const char[] newValue) {
