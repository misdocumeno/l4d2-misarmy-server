...
public void OnPluginStart()
{
	...
	RegAdminCmd("sm_forcescores", Command_ForceScores, ADMFLAG_SLAY, "sm_forcescores <survivor score> <infected score>");
}
...
Action Command_ForceScores(int client, int args)
{
	if (args < 2) {
		ReplyToCommand(client, "Usage: sm_setscores <survivor score> <infected score>");
		return Plugin_Handled;
	...
	SetScores(GetCmdArgInt(1), GetCmdArgInt(2), client);
	return Plugin_Handled;
}
